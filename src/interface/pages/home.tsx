...
export default function Home() {
    ...
    return <Grid width="100%" height="inherit" padding=".75rem 1rem" direction="vertical" css={{
        ...
        <Grid height="100%" spacing={16} justifyContent="space-between" css={{
            overflow: 'hidden'
        }}>
            <Grid width="65%" vertical justifyContent="space-between">
                <Grid height="fit-content" margin="24px 0 0" spacing={24} alignItems="center">
                    ...
                    <Grid vertical>
                        ...
                        <Typography size={18} color="$secondaryColor">
                            {account?.name}!
                        </Typography>
                    </Grid>
                </Grid>
                <Grid spacing={8} vertical>
                    <Grid justifyContent="space-between" css={{
                        ...
                        <Typography>
                            {t('interface:home.news.title')}
                        </Typography>
                        <Typography size={12} color="$secondaryColor" css={{
                            cursor: 'pointer'
                        }}>
                            {t('interface:common.action.view_all')}
                        </Typography>
                    </Grid>
                    <Grid width="100%" spacing={8} borderRadius={8} css={{
                        overflow: 'auto'
                    }}>
            ...
            <Grid width="35%" height="100%" spacing={16} vertical>
                <Grid justifyContent="space-between" css={{
                    ...
                    <Typography>
                        {t('interface:home.recent_instances.title')}
                    </Typography>
                    <Typography size={12} color="$secondaryColor" css={{
                        cursor: 'pointer'
                    }}>
