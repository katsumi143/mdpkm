...
import { Grid, Image, Select, Switch, Button, Tooltip, TextInput, TextHeader, Typography, BasicSpinner } from '../../../voxeliface';
...
export default Patcher.register(function Settings() {
    ...
    return <Grid width="100%" direction="vertical">
        <Grid width="100%" height="-webkit-fill-available" padding=".75rem 1rem" direction="vertical" css={{
            ...
            <TextHeader spacious>{t('app.mdpkm.settings.storage')}</TextHeader>
            <Grid spacing={8} padding="0 1rem" direction="vertical">
