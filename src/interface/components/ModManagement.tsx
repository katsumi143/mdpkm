...
export default function ModManagement({ instanceId }: ModManagementProps) {
    ...
    return <React.Fragment>
        ...
        >
            <TabItem name={t('mod_management.tab.0')} icon={<IconBiList/>} value={0}>
            ...
            <TabItem name={t('mod_management.tab.1')} icon={<IconBiSearch fontSize={11}/>} value={1}>
                {!canPopout && <ModSearch instance={instance}/>}
            </TabItem>
            <TabItem name={t('mod_management.tab.2')} icon={<IconBiDiamond/>} value={2} spacing={4} disabled={!instance.isModded}>
